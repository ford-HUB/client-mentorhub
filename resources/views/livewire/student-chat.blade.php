<div wire:poll.3s="loadMessages" wire:poll.5s="loadConversations">
    <div class="messaging-container">
        ...
        <div class="conversations-sidebar">
            <div class="sidebar-header">
                ...
                <div class="search-box">
                    <input type="text" wire:model.live="searchTerm" class="search-input" placeholder="Search Tutors...">
                    <span class="search-icon">🔍</span>
                </div>
            </div>
            <div class="conversations-list">
                @forelse($filteredConversations as $conversation)
                    <div class="conversation-item {{ $selectedTutorId == $conversation['id'] ? 'active' : '' }}" 
                ...
                @empty
                    <div class="empty-conversations">
                        ...
                        <p>Start a session with a tutor to begin messaging</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="chat-area">
            @if($selectedTutorId)
                @php
                    $selectedConversation = collect($conversations)->firstWhere('id', $selectedTutorId);
                @endphp
            ...
            @else
                <div class="empty-chat">
                    ...
                    <p>Choose a tutor from the sidebar to start messaging</p>
                </div>
            @endif
        </div>
    </div>
